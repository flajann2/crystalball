 ...
 * </UL>
 * @see Locator
 * @version $Revision: 1.3 $ $Date: 2006/08/21 20:06:51 $
 */
public class Driver extends ApplicationImpl
  ...
  public void endProlog(EndPrologEvent event) throws SAXException {
    ...
    for (Enumeration eenum = dtd.entityNames(DTD.NOTATION);
    ...
    for (Enumeration eenum = dtd.entityNames(DTD.GENERAL_ENTITY);
	 eenum.hasMoreElements();) {
      String name = (String)eenum.nextElement();

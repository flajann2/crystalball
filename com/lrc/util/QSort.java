...
public class QSort extends SortAlgorithm
{
    ...
    */
   void QuickSort(Vector v, int lo0, int hi0) throws Exception
   {
      int lo = lo0;
      int hi = hi0;
      SortItem mid;
      ...
      if (hi0 > lo0)
      {
         ...
         while(lo <= hi)
         {
             ...
             */
             while(lo < hi0 && pauseTrue(lo0, hi0) && compare(v, lo, mid) < 0)
                 ++lo;

            /* find an element that is smaller than or equal to
             * the partition element starting from the right Index.
             */
             while(hi > lo0 && pauseTrue(lo0, hi0) && compare(v, hi, mid) > 0)
                 --hi;
